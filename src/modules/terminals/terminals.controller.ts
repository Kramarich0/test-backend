...
export class TerminalsController {
  ...
  @ApiOkResponse({ description: 'List of terminals returned successfully.' })
  async getTerminals() {
  ...
  @ApiOkResponse({ description: 'Terminal details returned successfully.' })
  ...
  @ApiOkResponse({ description: 'Heartbeat acknowledged; status set to ACTIVE.' })
  @ApiNotFoundResponse({
